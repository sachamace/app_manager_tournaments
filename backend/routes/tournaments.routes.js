...
const { getTournaments, getTournament, getBracket, getTeamsRegister, getRanking, addTournament, addTeamsAtTournament, startTournament, cancelTournament ,generateNextRound,unsubscribeTeam, deleteTournament} = require('../controllers/tournaments.controller');
